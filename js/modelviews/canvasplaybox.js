...
var CanvasPlayBox = app.views.CanvasPlay.extend({
    getFixture: function (){
    ...
    setWorld: function (worldobj){
        ...
        fixDef.shape.SetAsBox(this.model.get('width') / 2, this.model.get('height') / 2);
...
app.views.canvasplay.itemView.addConstructor([null, app.validators.is_box], CanvasPlayBox);
