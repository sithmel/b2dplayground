...
var FormEditBox = app.views.FormEdit.extend({
    ...
    '</label>'+
    '<div class="control">' + 
    '<input name="start_angle" data-type="float" type="range" min="0" max="6.3" step="0.05" class="start_angle input-mini" value="<%-start_angle%>"/>' + 
    '</div>'+
    '</div>'+
    '<div class="control-group">' + 
...
app.views.formedit.itemView.addConstructor([null, app.validators.is_box], FormEditBox);
